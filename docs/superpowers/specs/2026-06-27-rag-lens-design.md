...
Next.js owns UI and server routes. Supabase owns Storage, Postgres, pgvector, trace persistence, and scheduled cleanup. Perplexity owns embeddings. OpenRouter owns V1 answer generation. Render owns the web app service.
